...
SECURE_HSTS_SECONDS = CONFIG.get('SECURE_HSTS_SECONDS', 0)
SECURE_HSTS_PRELOAD = CONFIG.get('SECURE_HSTS_PRELOAD', False)
SECURE_HSTS_INCLUDE_SUBDOMAINS = CONFIG.get('SECURE_HSTS_INCLUDE_SUBDOMAINS', False)
